...
class MoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mood" do
    assert_difference("Mood.count") do
      post moods_url, params: { mood: { fun: @mood.fun, health: @mood.health, notes: @mood.notes, productivity: @mood.productivity, user_id: @mood.user_id, vibe: @mood.vibe } }
    end
  ...
  test "should update mood" do
    patch mood_url(@mood), params: { mood: { fun: @mood.fun, health: @mood.health, notes: @mood.notes, productivity: @mood.productivity, user_id: @mood.user_id, vibe: @mood.vibe } }
